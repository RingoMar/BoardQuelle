const sounds = {
    ...
    'UHHHHHGHHH-OY': 'https://cdn.discordapp.com/attachments/567195386423279629/567196660455702529/Uggghh_Oy_remix.mp3',
    ...
    "ZOEYS P": 'https://cdn.discordapp.com/attachments/567195386423279629/567197104540221441/ZoeysP.mp3',
    ...
    'SQUAD THREE': 'https://cdn.discordapp.com/attachments/567195386423279629/567196602784284672/Squad_3.mp3',
    ...
    'TIER THREE SUB': 'https://cdn.discordapp.com/attachments/567195386423279629/567196645943672841/Tier_3_Sub_Song.mp3',
    ...
    "YOU'RE SQUAD THREE": 'https://cdn.discordapp.com/attachments/567195386423279629/567196691590283275/Youre_Squad_3.mp3',
    ...
    'FUCK SQUAD TWO': 'https://cdn.discordapp.com/attachments/567195386423279629/567196170925899776/F_Sqaud_2.mp3',
    ...
    'THAT SIXTY NINE': 'https://cdn.discordapp.com/attachments/567195386423279629/567196627022905380/that_69.mp3',
    ...
    "IS IT SQUAD THREE": 'https://cdn.discordapp.com/attachments/567195386423279629/567196276718829578/is_it_Squad_3.mp3',
    ...
    "TWO AT A TIME": 'https://cdn.discordapp.com/attachments/567195386423279629/569979125050245121/2_at_a_time.mp3',
    ...
    "TEN -SIXTY NINE": 'https://cdn.discordapp.com/attachments/567195386423279629/570677349138563084/10-69.mp3',
    ...
    "ZAQW": 'https://cdn.discordapp.com/attachments/567195386423279629/655213700231462920/zaqW.mp3',
    "FEELSDWINMAN": 'https://cdn.discordapp.com/attachments/567195386423279629/709478791604338789/FeelsDwinMan.mp3',
    "HUGH": 'https://cdn.discordapp.com/attachments/567195386423279629/709478810176716861/Thats_HUGH.mp3',
}
...
var dataid = 0;
let board = document.getElementById('audio-container')
for (let title of Object.keys(audios)) {
    if (title === "CLEANING THE AMBO") {
        let addaudio = document.createElement('audio')
        addaudio.setAttribute('preload', "auto")
        addaudio.setAttribute('class', "running")
        addaudio.setAttribute('data-key', "18")
        addaudio.setAttribute('data-id', dataid)
        dataid++
        addaudio.setAttribute('src', audios[title].src)
        board.appendChild(addaudio)
    } else {
        let addaudio = document.createElement('audio')
        addaudio.setAttribute('preload', "auto")
        addaudio.setAttribute('class', "running")
        addaudio.setAttribute('id', title.replace(/\s+/g, '_').replace(/[^\w\s]/gi, ''))
        addaudio.setAttribute('data-id', dataid)
        dataid++
        addaudio.setAttribute('src', audios[title].src)
        board.appendChild(addaudio)
...
var buld = 0;
let buildlist = document.getElementById('listbody')
for (let title of Object.keys(audios)) {
    if (title === "CLEANING THE AMBO") {
        let addtop = document.createElement('div')
        addtop.setAttribute('data-key', "18")
        addtop.setAttribute('id', "list__" + buld)
        addtop.setAttribute('class', "list__item col-md-6")
        buld++
        buildlist.appendChild(addtop)
    } else {
        let addtop = document.createElement('div')
        addtop.setAttribute('data-target', title.replace(/\s+/g, '_').replace(/[^\w\s]/gi, ''))
        addtop.setAttribute('id', "list__" + buld)
        addtop.setAttribute('class', "list__item col-md-6")
        buld++
        buildlist.appendChild(addtop)
...
var fews = 0;
for (let title of Object.keys(audios)) {
    let itel = document.getElementById("list__" + fews)
    let addkey = document.createElement('div')
    addkey.setAttribute('class', "list__item-key")
    addkey.textContent = ">"
    itel.appendChild(addkey)
    let addname = document.createElement('div')
    addname.setAttribute('class', "list__item-quote")
    addname.textContent = title
    itel.appendChild(addname)
    let loadinf = document.createElement('div')
    loadinf.setAttribute('class', "laoded")
    loadinf.setAttribute('id', "laoded__" + fews)
    itel.appendChild(loadinf)
    fews++
}
var percet = 0
...
(function () {
    ...
    $(".running").on('playing', function (event) {
        console.log("Playing")
        playing = true;
    });

    $(".running").on('ended', function (event) {
        playing = false;
    });
...
$(document).ready(function () {
  $('#tahhpfind').on('keyup', function () {
    var value = $(this).val().toLowerCase()
    $('#listbody *').filter(function () {
